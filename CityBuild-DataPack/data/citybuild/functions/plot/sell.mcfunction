...
execute if score @s cb_plots matches 1.. run tellraw @s {"text":"[CityBuild] ✓ ","color":"green","extra":[{"text":"Plot sold for $4000! New balance: $","color":"green"},{"score":{"name":"@s","objective":"cb_balance"},"color":"aqua"}]}
